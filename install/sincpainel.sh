...
wget https://github.com/THCRJ/PAINEL-5.0-DO-TH/raw/main/install/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/THCRJ/PAINEL-5.0-DO-TH/raw/main/install/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/THCRJ/PAINEL-5.0-DO-TH/raw/main/install/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/THCRJ/PAINEL-5.0-DO-TH/raw/main/install/sincpainel.zip > /dev/null 2>&1
